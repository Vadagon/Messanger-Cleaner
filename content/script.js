...
async function deletAllMessages(){
    console.log(2)
    $('div[role="grid"]').parent().parent().parent().animate({ scrollTop: 0 })
    await sleep(800)
    $('div[role="navigation"] div[aria-label="Menu"]').eq(0).click();
    await sleep(800)
    $('span:contains("Delete conversation")').closest('div[role="menuitem"]').eq(0).click()
    await sleep(800)
    $('span:contains("Delete Conversation")').closest('div[aria-label="Delete Conversation"]').eq(0).click()
    await sleep(800)
    $('div[role="grid"]').parent().parent().parent().animate({ scrollTop: 800 })
    await sleep(800)
    deletAllMessages()
}
